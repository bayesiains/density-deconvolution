...
We are grateful to David W. Hogg for providing us with the problem and advising us on our experimental setup.
Our experiments made use of AstroPy~\citep{astropy:2013,astropy:2018}, corner.py~\citep{corner}, Numpy~\citep{numpy}, Pandas~\citep{mckinney-proc-scipy-2010}, PyTorch~\citep{paszke2017automatic} and Scikit-learn~\citep{scikit-learn}.
